...
const blogUrl =
  "https://theblog.adobe.com/adobe-xd-for-jira-cloud-streamline-design-to-development-workflows/";
    ...
    <Fragment>
      ...
      >
        <Description
          ...
          text="Push the boundaries of design work"
        ></Description>
        <Card
          level="h4"
          space={0}
          img={mainSVG}
          imgAlt="Adobe XD Platform"
          marginLeft="5%"
          width="45%"
        ></Card>
      </Cards>
      ...
      >
        <Description
          ...
          textFontSize={24}
          title="Documentation"
          text="Everything you need to extend the Adobe XD experience"
        ></Description>
      </Cards>
      <Cards
        twoApis={true}
        wrapperPaddingBottom={40}
        minWidth={300}
        paddingTop={0}
        backgroundColor="white"
        height="auto"
      ...
      >
        <Description
          paddingBottom={10}
          arrowSVG={chevronSVG}
          imgAlt="Create your own plugin"
          width="100%"
          tagFontSize={24}
          color="white"
          rightTag="Create your own plugin"
          href={pluginLink}
          title="XD Plugins"
          text="Developers extend XD's core functionality with these types of plugins and more, all powered by the XD Plugin APIs."
        ></Description>
      </Cards>
      <Cards
        wrapperMarginBottom={-1}
      ...
      >
        <FeatureCard
          body="Connect designers with their teams and stakeholders"
          img={frontify}
          href="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=30cb8db1"
          href2="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=28192327"
          imgAlt="Frontify"
          img2={jira}
          imgAlt2="Jira"
          width="20%"
        ...
        ></FeatureCard>
        <FeatureCard
          body="Accelerate design work with new and unique features"
          img={arranger}
          imgAlt="Arranger"
          href="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=f0aac907"
          href2="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=bcd7a3a9"
          img2={renameit}
          imgAlt2="Rename It"
          width="20%"
          height={243}
        ...
        ></FeatureCard>
        <FeatureCard
          body="Enable designers to share their work anywhere"
          img={quest}
          href="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=2c680b2b"
          href2="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=232cee78"
          imgAlt="Quest"
          img2={overflow}
          imgAlt2="Overflow"
          width="20%"
        ...
        ></FeatureCard>
        <FeatureCard
          body="Help designers ensure their work connects with users"
          img={stark}
          href="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=6cbf275e"
          href2="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=713b61ec"
          imgAlt="Stark"
          img2={usertesting}
          imgAlt2="UserTesting"
          width="20%"
        ...
        ></FeatureCard>
        <FeatureCard
          body="Provide direct access to icons, images, data, and more"
          img={uifaces}
          href="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=aa845143"
          href2="https://adobe.com/go/xd_plugins_discover_plugin?pluginId=570d8b62"
          imgAlt="UI Faces"
          img2={icondrop}
          imgAlt2="Icondrop"
          width="20%"
      ...
      >
        <FeatureBoard
          link="Learn more"
          linkUrl={blogUrl}
          text="The Adobe XD and Jira Software Cloud integration uses the XD Cloud Content APIs to let designers associate XD prototypes and design specs with Jira issues. This keeps projects organized while providing developers with everything they need to know in the environment they know."
          title="Bringing designers and developers together"
          color="white"
          img={jiraSVG}
          imgAlt="Adobe XD and Jira Software Cloud"
          img2={featureLogoPNG}
          imgAlt2="Adobe XD and Jira Software Cloud video"
          tagFontSize={15}
          height="100%"
          backgroundColor="#505050"
          imgHeight={60}
      ...
      >
        <div class="middle-section">
          ...
          <div class="right">
            <img
              src={righttopPNG}
              title="Open the XD Plugin Manager"
              class="righttop"
            ></img>
            <div class="topText">
              <p class="normal">Plugin Manager</p>
              <p>
                The XD Plugin Manager lets designers discover plugins and
                integrations right where they spend their time: in Adobe XD.
              </p>
              <a style={styles.a} href="https://adobexd.app.link/IxAIxfGzjZ">
                Open in XD
              </a>
              <Description
                padding={0}
                ...
                text="You can publish your plugins and integrations with a description, screenshots, and more."
              ></Description>
              <Description
                padding={0}
                paddingBottom={0}
                ...
                textFontSize={15}
                color="black"
                title="Link to your listing"
                text="You'll get a unique URL that opens the XD Plugin Manager right to your plugin listing."
              ></Description>
              <Description
                padding={0}
                paddingBottom={0}
                ...
                text="Users can visit the XD Plugin Manager to browse and search for plugins you publish."
              ></Description>
            </div>
          </div>
        </div>
      ...
      >
        <Card
          ...
          href={forumLink}
          img={forumSVG}
          imgAlt="XD Platform developer forums"
          marginLeft={16}
          children="Join the XD Platform forums"
        ></Card>
        <Card
          imgMaxWidth="100%"
          level="h4"
          ...
          href={newsletterLink}
          img={newsletterSVG}
          imgAlt="CC Developer Newsletter"
          marginLeft={20}
          children="Sign up for the CC Developer Newsletter"
        ></Card>
        <Card
          imgMaxWidth="100%"
          level="h4"
          ...
          href={githubLink}
          img={githubSVG}
          imgAlt="Adobe XD on GitHub"
          marginLeft={20}
          children="Visit Adobe XD on GitHub"
        ></Card>
      </Cards>
      <Footer />
    </Fragment>
